...
const API_KEY = 'L2WuN64SG-5b4-iHIkLOTpMDazDfKmVb'
const COLLECTION_ADDRESSS = '0x928c403baC26D1811390d40700B8D32381113C77'
const API_BASE_URL = 'https://polygon-mainnet.g.alchemy.com'
...
fetch(
  ...
  .then((dataRes) => {
    const owners = dataRes.ownerAddresses
    let balance;
    for (let i = 0; i < owners.length; i++) {
      const startApp = async () => {
        balance = await contract.methods.balanceOf(owners[i], 1).call()
        
        arrayBal.push(balance)
        

        //generate random color
        const hexColor = '#' + Math.floor(Math.random() * 16777215).toString(16)
        randomHexColors.push(hexColor)
        const dataPie = {
          labels: owners,
          datasets: [
            {
  ...
  document.getElementById("open-link").onclick = () => {
    window.open("https://polygonscan.com/address/0x928c403baC26D1811390d40700B8D32381113C77");
  }
